package com.hensongeodata.technologies.agrihouse;
...
public class MyApplication extends Application {
      ...
      public boolean spinnerSelection(NiceSpinner niceSpinner){
      ...
      public boolean radioSelection(RadioGroup radioGroup){
